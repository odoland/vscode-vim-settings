# Generated by Powerlevel10k configuration wizard on 2020-07-03 at 17:02 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_TRUNCATE_BEFORE_MARKER="last" # "first" "last" or false
  ...
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS_PCT=75
  ...
  function my_git_formatter() {
    ...
    # Uncomment all VSC below to see again
